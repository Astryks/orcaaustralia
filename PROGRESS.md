...
**Homepage cover photo**: fixed properly now, in two passes. First pass anchored the crop to the top so faces showed, but that overcorrected and cropped out the shorts/bikini/boat below on wide screens. I mapped the exact pixel positions of the faces (y 40–260) and the shorts (y 420–680) on the source photo, made the hero section a bit taller, and picked a crop point that keeps both zones in frame. Verified on a wide range of real screen sizes (1920×1080, 1366×768, a short 1536×700 window, and a deliberately extreme 1920×600) plus mobile — faces, shorts/bikini, and the sailboat are all visible in every case.
